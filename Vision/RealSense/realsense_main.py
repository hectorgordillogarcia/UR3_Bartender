...
def GetRobotCoord(x_normalized,y_normalized, window_width,window_height,d_cam_robot):
    ...
    point_coordinates = getCanCoordinates(x_normalized, y_normalized, window_width, window_height)  # Devuelve x'={point_coordinates[0]}, y'={point_coordinates[1]}, z'={point_coordinates[2]}"
